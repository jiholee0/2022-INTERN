...
package nice.em.rm01.online.service.dto;
 ...
 */
@XmlType(propOrder={"apNo", "apSvcGbcd", "dtlSeq", "qstnrYmd", "qustn1Yn", "qustn1Cnts", "qustn2Yn", "qustn2Cnts", "qustn3Yn", "qustn3Cnts", "modiId", "modiDt", "fstRegId", "fstRegDt", "rsptNm", "rsptTel", "rspnsStatCd", "qstr1", "qstr2", "qstr3", "qstr4", "qstr5", "qstr6", "qstr7", "qstr8", "qstr9", "qstr10", "qstr11", "optQstr1No", "optQstr1", "optQstr2", "giftAyn", "connGb"}, name="SRM01ApPubQstnrInDto")
@XmlRootElement(name="SRM01ApPubQstnrInDto")
@SuppressWarnings("all")
public class SRM01ApPubQstnrInDto  implements IOmmObject, Predictable, FieldInfo  {

	private static final long serialVersionUID = -876634775L;
	...
	*******************************************************************************************************************************/
	/*******************************************************************************************************************************
	* Property set << optQstr1No >> [[ */
	
	@XmlTransient
	private boolean isSet_optQstr1No = false;
	
	protected boolean isSet_optQstr1No()
	{
		return this.isSet_optQstr1No;
	}
	
	protected void setIsSet_optQstr1No(boolean value)
	{
		this.isSet_optQstr1No = value;
	}
	
	
	@BxmOmm_Field(referenceType="reference", description="선택문항1_no", formatType="", format="", align="left", length=9, decimal=0, arrayReference="", fill="", comment="", validationRule="")
	private java.lang.String optQstr1No  = null;
	
	/**
	 * @Description 선택문항1_no
	 */
	public java.lang.String getOptQstr1No(){
		return optQstr1No;
	}
	 ...
	 * @Description 선택문항1_no
	 */
	@JsonProperty("optQstr1No")
	public void setOptQstr1No( java.lang.String optQstr1No ) {
		isSet_optQstr1No = true;
		this.optQstr1No = optQstr1No;
	}
	...
	* Property set << optQstr1 >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="선택문항1_cntr", formatType="", format="", align="left", length=500, decimal=0, arrayReference="", fill="", comment="", validationRule="")
	private java.lang.String optQstr1  = null;
	
	/**
	 * @Description 선택문항1_cntr
	 */
	...
	*******************************************************************************************************************************/
	...
	@Override
	public SRM01ApPubQstnrInDto clone(){
		try{
			SRM01ApPubQstnrInDto object= (SRM01ApPubQstnrInDto)super.clone();
			...
			if ( this.optQstr1No== null ) object.optQstr1No = null;
			else{
				object.optQstr1No = this.optQstr1No;
			}
	...
	public int hashCode(){
		...
		result = prime * result + ((optQstr1No==null)?0:optQstr1No.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final nice.em.rm01.online.service.dto.SRM01ApPubQstnrInDto other = (nice.em.rm01.online.service.dto.SRM01ApPubQstnrInDto)obj;
		if ( apNo == null ){
		...
		if ( qstr11 == null ){
			...
			return false;
		if ( optQstr1No == null ){
			if ( other.optQstr1No != null ) return false;
		}
		else if ( !optQstr1No.equals(other.optQstr1No) )
			return false;
		if ( optQstr1 == null ){
	...
	public String toString() {
		...
		sb.append( "\n[nice.em.rm01.online.service.dto.SRM01ApPubQstnrInDto:\n");
		sb.append("\tapNo: ");
		...
		sb.append("\n");
		sb.append("\toptQstr1No: ");
		sb.append(optQstr1No==null?"null":getOptQstr1No());
		sb.append("\n");
		sb.append("\toptQstr1: ");
	...
	public java.util.Map<String, Object> getFieldValues(){
		...
		fieldValueMap.put("optQstr1No", get("optQstr1No"));
	...
	public Object get(String key) throws IllegalArgumentException{
		...
		case -950101440 : /* qstr11 */
			return getQstr11();
		case 1669217151 : /* optQstr1No */
			return getOptQstr1No();
	...
	public void set(String key, Object value){
		...
		case -950101440 : /* qstr11 */
			...
			return;
		case 1669217151 : /* optQstr1No */
			setOptQstr1No((java.lang.String) value);
			return;
		case -101056226 : /* optQstr1 */
